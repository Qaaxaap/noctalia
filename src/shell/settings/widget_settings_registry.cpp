...
namespace settings {
  ...
  std::vector<WidgetSettingSpec> commonWidgetSettingSpecs(std::string_view shellFontFamily, bool populateFontCatalogs) {
    ...
    auto fontScale = withGroup(doubleSpec("font_scale", 1.0, 0.2, 2.5, 0.05), "presentation");
    ...
    return {
        ...
        std::move(fontScale),         std::move(widgetColor),     std::move(widgetIconColor), std::move(fontFamily),
        std::move(fontWeight),        std::move(capsuleToggle),   std::move(capsuleRadius),   std::move(capsuleFill),
        std::move(capsuleBorder),     std::move(capsuleForeground), std::move(capsulePadding), std::move(capsuleOpacity),
